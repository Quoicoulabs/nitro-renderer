...
export class NitroMessages implements IMessageConfiguration
{
    ...
    private registerEvents(): void
    {
        ...
        this._events.set(IncomingHeader.TWITCH_DISPLAY, TwitchDisplayStreamEvent);
        this._events.set(IncomingHeader.TWITCH_STREAM, TwitchStreamEvent);
    ...
    private registerComposers(): void
    {
        ...
        this._composers.set(OutgoingHeader.GET_TWITCH_DISPLAY_STATUS, GetTwitchDisplayStatusMessageComposer);
